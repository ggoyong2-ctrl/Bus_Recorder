...
3. 각각의 API호출명 당, 각각 일일 1000트래픽이 부여되며, 호출명 당 1000건의 제한은 이 프로그램을 사용하는데에는 다소 부족할 수도 있는 트래픽입니다. (데이터 갱신주기를 80~90초 정도로 느리게 설정하면 1000건의 호출 이내에서 1개노선의 하루 데이터를 받아볼 수 있으나, 일부 데이터가 누락될 가능성 존재함.)
